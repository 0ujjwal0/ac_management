...
class AC_ManagementSystem {
  ...
  public void book_appointment() {
        ...
        System.out.print("enter service details for that customer: ");
        String order = sc.nextLine();
        supplier.Place_appointment(order);

        System.out.println("Appointment successfully placed for the respective customer!");
  ...
  public void Total_appointment_placed() {
        ...
        if (Place_app.isEmpty()) {
            System.out.println("No service ordered for the customer ID:: " + id);
            return;
        }
        else
        {
